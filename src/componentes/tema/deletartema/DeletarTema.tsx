  ...
  return (
    <div className="container w-1/3 mx-auto">
      ...
      <div className="border flex flex-col rounded-2xl overflow-hidden justify-between">
        <header
          className="py-2 px-6 bg-indigo-600 text-white font-bold text-2xl">{tema.descricao}
        ...
        <div className="flex">
          ...
          <button className="text-slate-100 bg-indigo-400 hover:bg-indigo-600 w-full py-2 justify-center"
            onClick={deletarTema}>
            {
              isLoading ?
                <ClipLoader
